...
#define NUMBER_DZ_SIGNAL_FOR_RANG_SMALL          3
...
#define NUMBER_DZ_SIGNAL_FOR_RANG          7
...
#define MASKA_FOR_INPUT_SIGNALS_0        (unsigned int)(        \
  ...
  | (1 << (RANG_BLOCK_MTZ04_1 - 0))                             \
  | (1 << (RANG_BLOCK_MTZ04_2 - 0))                             \
)

#define MASKA_FOR_INPUT_SIGNALS_1        (unsigned int)(        \
    (1 << (RANG_BLOCK_USK_MTZ04_2 - 32))                      \
...
#define MASKA_FOR_INPUT_SIGNALS_4        (unsigned int)(      \
    (1 << (RANG_PUSK_UROV_VID_DV - 128))                      \
  | (1 << (RANG_BLOCK_ZOP - 128))                             \
...
#define MASKA_DZ_SIGNALS_1                0
#define MASKA_DZ_SIGNALS_2                0
...
#define MASKA_TZNP_SIGNALS_3       (unsigned int)(            \
   ...
   | (1 << (RANG_TZNP1 - 96))                                 \
   | (1 << (RANG_BLOCK_TZNP2 - 96))                           \
   | (1 << (RANG_SECTOR_TZNP2_VPERED - 96))                   \
   | (1 << (RANG_SECTOR_TZNP2_NAZAD - 96))                    \
...
#define MASKA_SIGNALES_FOR_LOCK_GROUP_PICKUP_1 (unsigned int)(\
     (1 << (RANG_PO_MTZ04_1 - 32))                            \
   | (1 << (RANG_MTZ04_1 - 32))                               \
   | (1 << (RANG_PO_MTZ04_2 - 32))                            \
   | (1 << (RANG_MTZ04_2 - 32))                               \
   | (1 << (RANG_PO_MTZ1 - 32))                               \
   | (1 << (RANG_PO_MTZN1_VPERED - 32))                       \
   | (1 << (RANG_PO_MTZN1_NAZAD - 32))                        \
...
/*****************************************/
//Макска моніторингу максимального фазного струму сторони ДЗ для дискретного реєстратора
/*****************************************/
...
#define MASKA_MONITOTYNG_MIN_Z_SIGNALES_2        0
