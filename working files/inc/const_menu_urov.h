...
enum _index_ml_ctrl_UROV
{
  ...
  INDEX_ML_CTRAPV_STARTED_FROM_DZ1,
  INDEX_ML_CTRAPV_STARTED_FROM_AMTDZ1,
  INDEX_ML_CTRAPV_STARTED_FROM_DZ2,
  INDEX_ML_CTRAPV_STARTED_FROM_AMTDZ2,
  INDEX_ML_CTRAPV_STARTED_FROM_DZ3,
  INDEX_ML_CTRAPV_STARTED_FROM_AMTDZ3,
  INDEX_ML_CTRAPV_STARTED_FROM_DZ4,
  INDEX_ML_CTRAPV_STARTED_FROM_AMTDZ4,
