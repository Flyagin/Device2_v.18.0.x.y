...
extern void make_ekran_control_mtz04(void);
...
extern void start_monitoring_min_Z_current(unsigned int);
extern void continue_monitoring_min_Z_current(unsigned int);
...
extern void end_monitoring_min_max_measurement(unsigned int, unsigned int*);
